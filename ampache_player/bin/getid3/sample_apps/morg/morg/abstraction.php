...
// +----------------------------------------------------------------------+
//
// $Id: abstraction.php,v 1.7 2007/01/03 16:15:59 ah Exp $
   ...
   */
   ...
   function flash($filename, $width = false, $height = false, $attr = null, $bgcolor = '#ffffff', $requied_flash_version = 6, $use_swfobject = true, $swfobject_name = "mymovie")
   {
       ...
       if ($use_swfobject) {
           ...
           return '
           <div width="'.$width.'" height="'.$height.'" id="'.$div_name.'"><table cellpadding=5 cellspacing=0 border=0 width="'.$width.'" height="'.$height.'"></tr><td bgcolor="'.$bgcolor.'"><b>Requires flash version '.$requied_flash_version.'</b></td></tr></table></div>
           <script type="text/javascript">
           <!--
              var so = new SWFObject("'.$filename.'", "'.$swfobject_name.'", "'.$width.'", "'.$height.'", "'.$requied_flash_version.'", "'.$bgcolor.'");
           ...
           <object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=$requied_flash_version,0,0,0' width='$width' height='$height' $attr>
               <param name='movie' value='$filename'>
               <param name='quality' value='high'>
               <param name='bgcolor' value='$bgcolor'>
               <embed src='$filename' quality='high' bgcolor='$bgcolor' width='$width' height='$height' type='application/x-shockwave-flash' pluginspace='http://www.macromedia.com/go/getflashplayer'></embed>
           </object>
           ";
       }
   }
...
class table
{
    ...
    */
    ...
    public function data($data = '', $attr = false)
    {
        ...
        // Colspan?
        $colspan = 1;
        if (eregi(" colspan=([\"'0-9]+) ", " $attr ", $regs)) {
        ...
        // rowspan?
        if (eregi(" rowspan=([\"'0-9]+) ", " $attr ", $regs)) {
    ...
    */
    ...
    { 
        ...
        $offs = 1+ ($offset+$this->curr_row-1) % ($sz-1);
...
class form
{
    ...
    */
    ...
    /**
    * Additional validation check before post.
    */
    
    public function additional_validation($code)
    {
